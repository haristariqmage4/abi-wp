...
add_action('mep_license_page_addon_list', 'mep_waitlist_licensing');
function mep_waitlist_licensing()
{
    $key_option_name        = 'mep_waitlist_license_key';
    $status_option_name     = 'mep_waitlist_license_status';
    $expire_option_name     = 'mep_waitlist_license_expire';
    $order_id_option_name   = 'mep_waitlist_license_order_id';
    $active_btn_id          = 'mep_waitlist_active';
    $deactive_btn_id        = 'mep_waitlist_deactive';
    $license                = get_option($key_option_name);
    $status                 = get_option($status_option_name);
?>
    <tr>
        <td><?php _e(MEP_WAITLIST_NAME, 'mage-eventpress-waitlist'); ?></td>
                        ...
                        if (key) {
                            jQuery.ajax({
                                ...
                                data: {
                                    ...
                                    "item_name"             : '<?php echo MEP_WAITLIST_NAME; ?>',
                                    "item_id"               : '<?php echo MEP_WAITLIST_ID; ?>',
                                    "key"                   : key
                                },
                                beforeSend: function() {
